      ...
      <div class="container-bacaan">
        ...
        <div class="bacaan-item">
          ...
          <div class="deskripsi">
            ...
            <div class="jumlah">{{ $totalRead }} Artikel</div>
          </div>
        </div>
        ...
        <div class="bacaan-item">
          <div class="ikon">
            <img class="ellipse-bg" src="{{ asset('img/Ellipse-4.png') }}" />
            <img class="ikon-atas" src="{{ asset('img/Vector2.png') }}" />
          </div>
          <div class="deskripsi">
            <div class="judul">Bacaan Lanjutan</div>
            <div class="jumlah">{{ $countLanjutan }} Artikel</div>
          </div>
        </div>
        ...
        <div class="bacaan-item">
          <div class="ikon">
            <img class="ellipse-bg" src="{{ asset('img/Ellipse-4.png') }}" />
            <img class="ikon-atas" src="{{ asset('img/menengah.png') }}" />
          </div>
          <div class="deskripsi">
            <div class="judul">Bacaan Menengah</div>
            <div class="jumlah">{{ $countMenengah }} Artikel</div>
          </div>
        </div>
        ...
        <div class="bacaan-item">
          <div class="ikon">
            <img class="ellipse-bg" src="{{ asset('img/Ellipse-4.png') }}" />
            <img class="ikon-atas" src="{{ asset('img/pemula.png') }}" />
          </div>
          <div class="deskripsi">
            <div class="judul">Bacaan Pemula</div>
            <div class="jumlah">{{ $countPemula }} Artikel</div>
          </div>
        </div>
      </div>
